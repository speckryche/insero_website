...
export const zoomFaq: ZoomFAQ[] = [
  {
    ...
    a: "Yes — and it is the biggest Zoom Workplace differentiator. AI Companion is included at no extra cost with eligible paid Zoom Workplace plans, so call and meeting summaries, voicemail prioritization, and task extraction come standard rather than as a line-item add-on. The most advanced pieces — the AI Concierge for voice, Custom AI Companion agents, and the deeper sales-intelligence tiers — are paid add-ons. But the baseline 'capable AI included' bar is set higher here than almost anywhere else.",
  },
  {
  ...
  },
  {
    ...
    a: "Effectively, yes — AI Companion is included at no additional charge with eligible paid Zoom Workplace plans rather than sold as a separate license. That's the core reason Zoom Phone is often the most cost-effective on-ramp to genuinely useful AI: summaries, task extraction, and 'ask AI Companion' answers come with the seat. The caveats are that it applies to eligible paid plans, and that the most advanced agentic features — like AI Concierge — are paid add-ons. We'll confirm your specific plan covers what you're expecting.",
  },
  {
  ...
  },
  {
    ...
    a: "Both are strong, mature platforms; the honest split is value-and-simplicity versus depth. The Zoom Phone edge is that capable AI (AI Companion) is included and the experience is famously simple — ideal if your team already lives in Zoom Meetings. RingCentral's edge is the depth of its contact-center and conversation-intelligence stack, though its most powerful AI is sold as add-ons. If you want AI included and easy deployment, Zoom Phone usually wins; if you need the deepest contact center, RingCentral often does. We'll compare both against your real needs.",
  },
];
