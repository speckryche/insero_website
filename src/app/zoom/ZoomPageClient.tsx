          ...
          <motion.div {...fadeUp} className="max-w-3xl mb-14">
            ...
            <div className="space-y-5 text-lg md:text-xl text-[var(--color-gray-500)]">
              <p>
                ...
                Zoom&apos;s published rates, the same ones you would be quoted going direct.
              </p>
              <p>
                ...
                number — using Zoom&apos;s current promotions, pricing programs that are not always
              ...
              <p>
                Because we are not Zoom&apos;s sales team, we are free to tell you when something else fits you
