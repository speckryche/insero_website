...
export function Footer() {
  ...
  return (
    <footer className="concept-footer bg-[#1a2530] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-white/60 text-sm">Follow us on LinkedIn</span>
            </div>
          </div>
      ...
      {/* Bottom Bar */}
      {/* white/60, not white/40: on the #1a2530 footer, white/40 measures
          3.69:1 and misses AA for 14px text. white/60 is 6.48:1 and is the
          token the brand paragraph above already uses. */}
