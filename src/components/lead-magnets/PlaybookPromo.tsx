  ...
  return (
    <>
      <div className="max-w-3xl mx-auto mt-10 bg-[#f8fafb] rounded-2xl border border-gray-200 p-6 lg:p-8 text-center">
        <h3 className="font-display font-bold text-xl text-[#1e293b] mb-2">Want the full playbook?</h3>
        <p className="text-sm text-[#475569] mb-5 max-w-md mx-auto">
          Get our step-by-step POTS Replacement Playbook — inventory templates, compliance checklists, and pricing guides in one PDF.
        </p>
        <button
